...
// Well add amember SoundPlayer& mSounds to the Button class. 
// Well then adapt its con-structor to take an entire Context object and initialize the reference to the soundplayer:
// In the Button::activate() method, which is called when a button is clicked,we'll play the corresponding sound:


// https://github.com/SFML/SFML-Game-Development-Book/blob/master/09_Audio/Source/Button.cpp
